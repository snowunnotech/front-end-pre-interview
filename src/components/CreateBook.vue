<template>
  <div class="wrapper">
    <nav-bar :leftButton="leftButton" :rightButton="rightButton" title="Add New Book"/>
    <div class="content">
...
const { mapMutations } = createNamespacedHelpers('book');
  ...
  data() {
    return {
      rightButton: {
        text: 'Save',
        click: () => {
          this.postBookInfo(this.bookInfo);
          this.$router.back();
        }
      },
      leftButton: {
